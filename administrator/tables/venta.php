 ...
 * @since  1.6
 */
class ServinTableventa extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'ServinTableventa', array('typeAlias' => 'com_servin.venta'));
		parent::__construct('#__servin_ventas', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_servin.venta.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_servin/access.xml',
				"/access/section[@name='venta']/"
			);
			$default_actions = JAccess::getAssetRules('com_servin.venta.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_servin.venta.' . (int) $this->$k;
	}
