 ...
 * @since  1.6
 */
class ServinTabledeuda extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'ServinTabledeuda', array('typeAlias' => 'com_servin.deuda'));
		parent::__construct('#__servin_deudas', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_servin.deuda.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_servin/access.xml',
				"/access/section[@name='deuda']/"
			);
			$default_actions = JAccess::getAssetRules('com_servin.deuda.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_servin.deuda.' . (int) $this->$k;
	}
