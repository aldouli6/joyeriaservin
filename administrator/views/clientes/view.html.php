 ...
 * @since  1.6
 */
class ServinViewClientes extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ServinHelper::addSubmenu('clientes');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SERVIN_TITLE_CLIENTES'), 'clientes.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_servin&view=clientes');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`nombre`' => JText::_('COM_SERVIN_CLIENTES_NOMBRE'),
			'a.`direccion`' => JText::_('COM_SERVIN_CLIENTES_DIRECCION'),
			'a.`telefono`' => JText::_('COM_SERVIN_CLIENTES_TELEFONO'),
			'a.`correo`' => JText::_('COM_SERVIN_CLIENTES_CORREO'),
			'a.`fotocomprobante`' => JText::_('COM_SERVIN_CLIENTES_FOTOCOMPROBANTE'),
		);
	}
