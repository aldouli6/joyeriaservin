...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_servin&task=deudas.saveOrderAjax&tmpl=component';
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="deudaList">
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SERVIN_DEUDAS_FECHA_COMPRA', 'a.`fecha_compra`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SERVIN_DEUDAS_FECHA_LIMITE', 'a.`fecha_limite`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SERVIN_DEUDAS_TOTAL', 'a.`total`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SERVIN_DEUDAS_ABONO', 'a.`abono`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
