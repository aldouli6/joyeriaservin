 ...
 * @since  1.6
 */
class ServinViewHechuras extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ServinHelper::addSubmenu('hechuras');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SERVIN_TITLE_HECHURAS'), 'hechuras.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_servin&view=hechuras');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`numero`' => JText::_('COM_SERVIN_HECHURAS_NUMERO'),
			'a.`costo`' => JText::_('COM_SERVIN_HECHURAS_COSTO'),
			'a.`tipo_ganancia`' => JText::_('COM_SERVIN_HECHURAS_TIPO_GANANCIA'),
			'a.`ganancia`' => JText::_('COM_SERVIN_HECHURAS_GANANCIA'),
		);
	}
