 ...
 * @since  1.6
 */
class ServinViewPiezas extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ServinHelper::addSubmenu('piezas');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SERVIN_TITLE_PIEZAS'), 'piezas.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_servin&view=piezas');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`material`' => JText::_('COM_SERVIN_PIEZAS_MATERIAL'),
			'a.`kilataje`' => JText::_('COM_SERVIN_PIEZAS_KILATAJE'),
			'a.`ubicacion`' => JText::_('COM_SERVIN_PIEZAS_UBICACION'),
			'a.`hechura`' => JText::_('COM_SERVIN_PIEZAS_HECHURA'),
			'a.`descripcion`' => JText::_('COM_SERVIN_PIEZAS_DESCRIPCION'),
			'a.`peso`' => JText::_('COM_SERVIN_PIEZAS_PESO'),
			'a.`precio`' => JText::_('COM_SERVIN_PIEZAS_PRECIO'),
			'a.`estatus`' => JText::_('COM_SERVIN_PIEZAS_ESTATUS'),
		);
	}
