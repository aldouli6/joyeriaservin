...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_servin&task=piezas.saveOrderAjax&tmpl=component';
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="piezaList">
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SERVIN_PIEZAS_KILATAJE', 'a.`kilataje`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SERVIN_PIEZAS_UBICACION', 'a.`ubicacion`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SERVIN_PIEZAS_PRECIO', 'a.`precio`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SERVIN_PIEZAS_ESTATUS', 'a.`estatus`', $listDirn, $listOrder); ?>
				</th>
