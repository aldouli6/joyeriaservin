 ...
 * @since  1.6
 */
class ServinViewCompras extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ServinHelper::addSubmenu('compras');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SERVIN_TITLE_COMPRAS'), 'compras.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_servin&view=compras');
	}
