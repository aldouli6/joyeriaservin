...
<form
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_SERVIN_TITLE_PIEZA', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('created_at'); ?>				<?php echo $this->form->renderField('material'); ?>
