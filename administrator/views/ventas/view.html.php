 ...
 * @since  1.6
 */
class ServinViewVentas extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ServinHelper::addSubmenu('ventas');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SERVIN_TITLE_VENTAS'), 'ventas.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_servin&view=ventas');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`piezas`' => JText::_('COM_SERVIN_VENTAS_PIEZAS'),
			'a.`fecha`' => JText::_('COM_SERVIN_VENTAS_FECHA'),
			'a.`cliente`' => JText::_('COM_SERVIN_VENTAS_CLIENTE'),
			'a.`total`' => JText::_('COM_SERVIN_VENTAS_TOTAL'),
			'a.`metodo_pago`' => JText::_('COM_SERVIN_VENTAS_METODO_PAGO'),
		);
	}
