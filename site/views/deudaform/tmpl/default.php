...
<div class="deuda-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-deuda"
			  action="<?php echo JRoute::_('index.php?option=com_servin&task=deuda.save'); ?>"
	...
	<?php echo $this->form->renderField('estatus'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_servin&task=deudaform.cancel'); ?>"
