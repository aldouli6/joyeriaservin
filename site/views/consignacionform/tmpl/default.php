...
<div class="consignacion-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-consignacion"
			  action="<?php echo JRoute::_('index.php?option=com_servin&task=consignacion.save'); ?>"
	...
	<?php echo $this->form->renderField('estatus'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_servin&task=consignacionform.cancel'); ?>"
