...
<div class="item_fields">
	...
	<table class="table">
		...
		<tr>
			<th><?php echo JText::_('COM_SERVIN_FORM_LBL_PIEZA_KILATAJE'); ?></th>
			<td><?php echo $this->item->kilataje; ?></td>
		</tr>

		<tr>
			<th><?php echo JText::_('COM_SERVIN_FORM_LBL_PIEZA_UBICACION'); ?></th>
		...
		<tr>
			<th><?php echo JText::_('COM_SERVIN_FORM_LBL_PIEZA_PESO'); ?></th>
			<td><?php echo $this->item->peso; ?></td>
		</tr>

		<tr>
			<th><?php echo JText::_('COM_SERVIN_FORM_LBL_PIEZA_PRECIO'); ?></th>
			<td><?php echo $this->item->precio; ?></td>
		</tr>

		<tr>
			<th><?php echo JText::_('COM_SERVIN_FORM_LBL_PIEZA_ESTATUS'); ?></th>
...
<?php if($canEdit && $this->item->checked_out == 0): ?>
	...
	<a class="btn" href="<?php echo JRoute::_('index.php?option=com_servin&task=pieza.edit&id='.$this->item->id); ?>"><?php echo JText::_("COM_SERVIN_EDIT_ITEM"); ?></a>

<?php endif; ?>

<?php if (JFactory::getUser()->authorise('core.delete','com_servin.pieza.'.$this->item->id)) : ?>
	...
	<div id="deleteModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="deleteModal" aria-hidden="true">
		...
		<div class="modal-footer">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_servin&task=pieza.remove&id=' . $this->item->id, false, 2); ?>" class="btn btn-danger">
				<?php echo JText::_('COM_SERVIN_DELETE_ITEM'); ?>
			</a>
		</div>
	</div>
