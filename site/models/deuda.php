 ...
 * @since  1.6
 */
class ServinModelDeuda extends JModelItem
{
    public $_item;
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_servin')) && (!$user->authorise('core.edit', 'com_servin')))
		{
		...
		if ($this->_item === null)
		{
			...
			if ($table->load($id))
			{
				...
				if ($published = $this->getState('filter.published'))
				{
					...
					{
						throw new Exception(JText::_('COM_SERVIN_ITEM_NOT_LOADED'), 403);
					}
				}
