 ...
 * @since  1.6
 */
class ServinControllerCliente extends JControllerLegacy
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Cliente', 'ServinModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_servin') || $user->authorise('core.edit.state', 'com_servin'))
		{
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_servin&view=clientes', false));
			}
			else
			{
	...
	public function remove()
	{
		...
		if ($user->authorise('core.delete', 'com_servin'))
		{
			...
			else
			{
                ...
                $app->redirect(JRoute::_('index.php?option=com_servin&view=clientes', false));
			}
